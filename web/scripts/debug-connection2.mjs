// web/scripts/debug-connection2.mjs
// Script alternativo para depurar la conexión con el contrato

console.log('=== Iniciando depuración de conexión ===\n');

// Intentar importar directamente el contenido de los archivos TypeScript
const fs = require('fs');
