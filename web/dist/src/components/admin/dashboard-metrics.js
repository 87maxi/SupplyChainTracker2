"use strict";
// web/src/components/admin/dashboard-metrics.tsx
'use client';
// web/src/components/admin/dashboard-metrics.tsx
...
const DashboardMetrics = ({ rolesSummary, pendingRequestsCount, recentActivity = { tokensCreated: 0, transfersCompleted: 0, approvalsPending: 0 }, loading = false }) => {
    var _a, _b, _c, _d, _e;
    if (loading) {
...
const RoleMetricCard = ({ title, count, icon: Icon, color }) => (<card_1.Card className="text-center hover:shadow-lg transition-shadow">
    <card_1.CardContent className="p-6">
