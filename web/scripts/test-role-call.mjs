// web/scripts/test-role-call.mjs
...
import { publicClient } from '../src/lib/blockchain/client.js';
import { NEXT_PUBLIC_SUPPLY_CHAIN_TRACKER_ADDRESS } from '../src/lib/env.js';
