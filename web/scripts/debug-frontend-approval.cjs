...
async function debugFrontendApproval() {
  console.log('=== DEBUG FRONTEND APPROVAL ISSUE ===');
  ...
  try {
    ...
    for (const pendingRequest of pendingRequests) {
      ...
      // Simulate the approval process that should happen in the frontend
