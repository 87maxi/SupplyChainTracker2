...
const badgeVariants = (0, class_variance_authority_1.cva)("inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2", {
    variants: {
        variant: {
            ...
            success: "border-transparent bg-emerald-500/20 text-emerald-500 border-emerald-500/20",
            warning: "border-transparent bg-amber-500/20 text-amber-500 border-amber-500/20",
            glass: "bg-white/10 backdrop-blur-md border-white/20 text-white",
            "outline-glow": "bg-transparent border-primary/50 text-primary shadow-[0_0_10px_rgba(59,130,246,0.3)]",
        },
    },
    defaultVariants: {
        variant: "default",
