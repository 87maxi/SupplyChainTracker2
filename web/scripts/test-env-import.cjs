// web/scripts/test-env-import.cjs
...
try {
    ...
    console.log('Módulo env importado usando createRequire:', env);
} catch (error) {
    console.log('Error al importar usando createRequire:', error.message);
}