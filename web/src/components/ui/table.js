...
const Table = React.forwardRef((_a, ref) => {
    ...
    return (<table ref={ref} className={(0, utils_1.cn)("w-full caption-bottom text-sm", className)} {...props}/>);
});
exports.Table = Table;
...
const TableHead = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (<th ref={ref} className={(0, utils_1.cn)("h-10 px-2 text-left align-middle font-medium text-muted-foreground [&:has([role=checkbox])]:pr-0", className)} {...props}/>);
});
exports.TableHead = TableHead;
TableHead.displayName = "TableHead";
const TableCell = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (<td ref={ref} className={(0, utils_1.cn)("p-2 align-middle [&:has([role=checkbox])]:pr-0", className)} {...props}/>);
});
